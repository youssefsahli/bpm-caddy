...
const GUIDE_SHORTCUTS: &str = "Ctrl+K aller à… · Ctrl+F chercher un patient · Ctrl+N nouvel entretien · Ctrl+Tab et Ctrl+Shift+Tab onglet suivant et précédent · Ctrl+W fermer l'onglet · F1 panneau d'équipe · F2 tableau de bord · F3 médicaments · F4 agenda · F5 carnet · F6 liste de gauche · F7 carte vaccinale · F9 la fenêtre réduite en barre, où Alt + 1 … 5 appellent ses cinq gestes · F12 cette liste · Échap ferme l'élément ouvert. Dans une liste — patients, protocoles, préparations, dispositifs — tapez dans son champ de recherche, puis les flèches parcourent et Entrée ouvre ; sur un dossier, Alt et les flèches changent d'onglet, et dans le choix rapide les chiffres 1 … 9, 0 posent l'acte. Dates : 230826 donne 23/08/2026, 2308 donne le 23/08, l'année étant déduite du champ.";
