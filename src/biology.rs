...
const RULES: &[Rule] = &[
    ...
    Rule {
        ...
        side: Side::Below,
        threshold: 150.0,
        needs: &["prednisone", "prednisolone", "cortancyl", "solupred", "célestène", "médrol", "corticoïde substitutif", "prednisone", "prednisolone", "hydrocortisone", "corticothérapie"],
        severity: Severity::Alert,
    ...
    Rule {
        ...
        side: Side::Above,
        threshold: 5.0,
        needs: &["pril", "IEC", "sartan", "spironolactone", "éplérénone", "finérénone"],
        severity: Severity::Alert,
    ...
    Rule {
        ...
        side: Side::Above,
        threshold: 1000.0,
        needs: &["vastatine", "fibrate", "atorvastatine", "simvastatine", "rosuvastatine"],
        severity: Severity::Alert,
    ...
    Rule {
        ...
        side: Side::Below,
        threshold: 150.0,
        needs: &["metformine", "biguanide", "oméprazole", "ésoméprazole", "pantoprazole", "lansoprazole", "rabéprazole", "oméprazole", "pantoprazole", "ésoméprazole"],
        severity: Severity::Warn,
    ...
    Rule {
        ...
        side: Side::Above,
        threshold: 240.0,
        needs: &["amoxicilline", "clavulanique", "antifongique", "vastatine", "macrolide"],
        severity: Severity::Alert,
    ...
    Rule {
        ...
        needs: &[
            "immunosuppresseur",
            "anti-TNF",
            "prednisone", "prednisolone", "cortancyl", "solupred", "célestène", "médrol", "corticoïde substitutif",
            "méthotrexate",
            "azathioprine",
        ],
        severity: Severity::Alert,
    ...
    Rule {
        ...
        side: Side::Above,
        threshold: 3.0,
        needs: &["pril", "IEC", "sartan", "gliflozine", "dapagliflozine", "empagliflozine"],
        severity: Severity::Warn,
    ...
    Rule {
        ...
        side: Side::Below,
        threshold: 0.40,
        needs: &["vastatine", "fibrate", "ézétimibe"],
        severity: Severity::Info,
    ...
    Rule {
        ...
        side: Side::Below,
        threshold: 0.5,
        needs: &["fingolimod", "diméthyle", "tériflunomide", "interféron bêta", "tériflunomide", "fingolimod", "cladribine", "natalizumab", "ocrélizumab", "ofatumumab", "immunomodulateur", "modulateur S1P"],
        severity: Severity::Alert,
    ...
    Rule {
        ...
        side: Side::Below,
        threshold: 1.0,
        needs: &["immunosuppresseur", "prednisone", "prednisolone", "cortancyl", "solupred", "célestène", "médrol", "corticoïde substitutif", "méthotrexate", "azathioprine", "mycophénolate"],
        severity: Severity::Warn,
    ...
    Rule {
        ...
        side: Side::Above,
        threshold: 50.0,
        needs: &["prednisone", "prednisolone", "cortancyl", "solupred", "célestène", "médrol", "corticoïde substitutif", "immunosuppresseur", "anti-TNF", "méthotrexate", "prednisone"],
        severity: Severity::Alert,
    ...
    Rule {
        ...
        side: Side::Above,
        threshold: 12.0,
        needs: &["prednisone", "prednisolone", "cortancyl", "solupred", "célestène", "médrol", "corticoïde substitutif", "prednisone", "prednisolone", "méthylprednisolone"],
        severity: Severity::Info,
