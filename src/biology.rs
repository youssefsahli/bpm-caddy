...
const RULES: &[Rule] = &[
    ...
    Rule {
        ...
        side: Side::Below,
        threshold: 150.0,
        needs: &["metformine", "biguanide", "oméprazole", "ésoméprazole", "pantoprazole", "lansoprazole", "rabéprazole"],
        severity: Severity::Warn,
    ...
    Rule {
        ...
        side: Side::Above,
        threshold: 1.26,
        needs: &["prednisone", "prednisolone", "cortancyl", "solupred", "célestène", "médrol", "corticoïde substitutif", "antipsychotique"],
        severity: Severity::Warn,
    ...
    Rule {
        ...
        side: Side::Above,
        threshold: 50.0,
        needs: &["prednisone", "prednisolone", "cortancyl", "solupred", "célestène", "médrol", "corticoïde substitutif", "immunosuppresseur", "anti-TNF", "méthotrexate"],
        severity: Severity::Alert,
