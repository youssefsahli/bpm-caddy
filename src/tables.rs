...
pub const TABLES: &[ConvTable] = &[
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["Comment se trace un biologique ?", "Par le nom de marque **et** le numéro de lot, jamais par la DCI seule", "Noter les deux à chaque délivrance : cela permet de rattacher un effet indésirable au bon produit", "Écrire « adalimumab » sur la fiche : trois spécialités le sont, et une déclaration de pharmacovigilance sans marque ne sert à rien"],
