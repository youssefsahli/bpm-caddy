...
pub const TABLES: &[ConvTable] = &[
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["Tinzaparine (Innohep)", "175 UI/kg x1/j", "3 500 à 4 500 UI x1/j", "Le RCP descend plus bas que les autres HBPM, l'accumulation étant la mieux documentée comme absente ; la pratique française garde le seuil de 30 mL/min à dose curative, et c'est le prescripteur qui tranche", "Anti-Xa 4 h après l'injection si contrôle nécessaire", "Sulfate de protamine — neutralisation partielle"],
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["Motifs d'arrêt et d'appel", "Saignement qui ne cède pas à la compression", "Selles noires ou sang dans les urines", "Traumatisme crânien, même sans perte de connaissance", "Grossesse : les AOD sont contre-indiqués", "Insuffisance hépatique sévère ou coagulopathie : contre-indication"],
        ],
    },
    ConvTable {
        ...
        rows: &[
            ...
            &["Signes d'un asthme non contrôlé", "Symptômes diurnes plus de deux fois par semaine", "Réveils nocturnes", "Recours au traitement de secours plus de deux fois par semaine", "Limitation de l'activité physique", "Trois flacons de secours délivrés dans l'année, ou un flacon par mois : signaler au prescripteur"],
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["Âge 15 à 44 ans", "0", "Allergie aux pénicillines sans contre-indication aux céphalosporines", "Céphalosporine de 2e ou 3e génération", "Céfuroxime-axétil 250 mg x2/j pendant 4 jours, ou cefpodoxime-proxétil 100 mg x2/j pendant 5 jours"],
            &["Âge ≥ 45 ans", "−1", "Contre-indication à toutes les bêta-lactamines", "Macrolide, après prélèvement de gorge pour culture", "Azithromycine 500 mg/j pendant 3 jours, ou clarithromycine 250 mg x2/j pendant 5 jours"],
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["Sous inducteur enzymatique (rifampicine, millepertuis, antiépileptiques inducteurs)", "Pendant tout le traitement et encore 4 semaines après son arrêt", "La pilule, l'implant, le patch et l'anneau échouent tous, et l'échec est silencieux jusqu'au test de grossesse. Le DIU au cuivre et le dispositif au lévonorgestrel sont les deux méthodes que l'induction ne touche pas", "Oui, pendant tout le traitement et les 4 semaines qui suivent", "Le lévonorgestrel est inefficace à la dose habituelle et l'ulipristal n'est pas recommandé : c'est le DIU au cuivre, jusqu'à 5 jours. À défaut, avis médical le jour même"],
        ],
    },
    ConvTable {
        short: "Antalgiques",
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["Calcium, fer, magnésium, zinc", "Chélation dans le tube digestif", "Cyclines, fluoroquinolones, lévothyroxine, biphosphonates", "Absorption effondrée, échec du traitement sans autre signe", "Espacer d'au moins 2 heures, dans un sens ou dans l'autre. La lévothyroxine et les bisphosphonates se prennent à jeun et seuls, et l'écart y gagne à être plus grand encore. Vérifier aussi les eaux minérales riches en calcium."],
            ...
            &["Jus de canneberge et compléments", "Interférence discutée avec le métabolisme des antivitamines K", "Antivitamines K", "Effet sur l'INR probablement modeste, mais des déséquilibres à la hausse ont été rapportés sous apports importants", "Ne pas l'interdire : c'est la régularité de l'apport qui compte, et un contrôle d'INR après tout changement d'habitude. Un apport quotidien nouveau et important se signale au prescripteur."],
        ],
    },
    ConvTable {
        short: "Urgence",
    ...
    ConvTable {
        ...
        columns: &["Médicament ou classe", "Risque après 75 ans", "Alternative", "Si maintenu"],
        rows: &[
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["AINS à partir du début du 6e mois de grossesse (24 SA)", "Contre-indication absolue, même en prise unique : fermeture du canal artériel et atteinte rénale fœtale. Avant ce terme, ils sont déconseillés", "Paracétamol à la dose efficace la plus faible", "Toute douleur qui résiste chez une femme enceinte : avis médical"],
            ...
            &["Millepertuis en automédication", "Inducteur enzymatique puissant : contraceptifs, anticoagulants, immunosuppresseurs, antirétroviraux, anticancéreux perdent leur efficacité", "Vérifier l'ordonnance entière avant tout conseil", "Humeur triste durable, idées noires : consultation, pas une plante"],
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["La durée est le traitement", "Celle de l'ordonnance, ni plus ni moins", "—", "Arrêter dès que les symptômes cèdent : cela sélectionne les résistances et fait rechuter", "Un reste de boîte ne se garde pas pour la prochaine fois, et ne se donne à personne"],
    ...
    ConvTable {
        ...
        columns: &["Traitement", "Risque de l'arrêt brutal", "Décroissance", "Surveillance", "Signes d'alerte"],
        rows: &[
    ...
    ConvTable {
        short: "Conduite",
        family: "Au comptoir",
        title: "Conduite automobile — niveaux du pictogramme",
        ...
        rows: &[
            ...
            &["Cadre légal", "Conduire sous l'effet d'un médicament n'est pas une infraction en soi", "—", "Mais l'assurance peut réduire sa garantie, et la responsabilité reste engagée en cas d'accident", "Le pictogramme sur la boîte : il vaut information donnée"],
    ...
    ConvTable {
        ...
        columns: &["Point", "Réponse", "Conduite à tenir", "Écueil"],
        rows: &[
            &["Biosimilaire et générique", "Non. Un générique est la même molécule chimique ; un biosimilaire est une protéine produite par une lignée cellulaire vivante, dont la comparabilité au médicament de référence est établie par un dossier de qualité, de pharmacocinétique et de clinique", "L'expliquer au patient dans ces termes : une équivalence démontrée, non une copie approximative", "Employer le mot « générique » devant le patient : cela installe une méfiance qu'il faudra défaire ensuite"],
            &["Substitution en officine", "Seulement pour les groupes biologiques similaires inscrits par arrêté. La liste est courte et se vérifie : elle a commencé par le filgrastim et le pegfilgrastim", "Vérifier la liste en vigueur avant toute substitution ; hors de ces groupes, la substitution en officine n'est pas permise", "Supposer que ce qui vaut pour un groupe vaut pour tous : chaque groupe est inscrit un par un"],
            &["Mention « non substituable »", "Oui : la mention « non substituable » portée à la main sur l'ordonnance, avec sa justification, ferme la substitution pour cette ligne", "Respecter la mention et délivrer la spécialité prescrite ; ne pas la contourner", "Une mention pré-imprimée ou générale ne vaut pas : elle est manuscrite et propre à la ligne"],
            &["Obligations en cas de substitution", "Informer le patient, inscrire la spécialité délivrée sur l'ordonnance, et informer le prescripteur", "Les trois, à chaque fois — l'information du prescripteur n'est pas facultative", "Substituer sans informer le patient : changement de boîte et de stylo non expliqué"],
            &["Continuité du traitement", "La continuité prime : on délivre la même spécialité pour toute la durée du traitement", "Noter la spécialité choisie sur la fiche patient, pour que la délivrance suivante soit la même", "Changer de marque au gré du stock : c'est le changement répété, plus que le biosimilaire, qui inquiète le patient et brouille la traçabilité"],
            &["Traçabilité", "Par le nom de marque **et** le numéro de lot, jamais par la DCI seule", "Noter les deux à chaque délivrance : cela permet de rattacher un effet indésirable au bon produit", "Écrire « adalimumab » sur la fiche : trois spécialités le sont, et une déclaration de pharmacovigilance sans marque ne sert à rien"],
            &["Dispositif d'injection", "Oui, presque toujours : les stylos, les seringues et leur gestuelle diffèrent d'une marque à l'autre, même à dose identique", "Remontrer la technique à chaque changement de spécialité, y compris à un patient qui s'injecte depuis des années", "Croire que « c'est la même molécule, donc le même geste » : la mauvaise technique est la première cause de dose non reçue"],
            &["Interchangeabilité", "Le prescripteur, à tout moment, dans les deux sens et entre biosimilaires, avec information du patient. C'est l'interchangeabilité, et elle est distincte de la substitution en officine", "Distinguer les deux mots devant le patient : le médecin interchange, le pharmacien substitue dans les groupes prévus", "Confondre les deux et croire qu'un switch décidé par le médecin autorise la substitution au comptoir"],
            &["Information et accord du patient", "Oui : il est informé et son opposition se respecte", "Prendre le temps d'expliquer plutôt que d'imposer ; un refus se note sur la fiche", "Passer en force pour une différence de prix : le traitement abandonné coûte plus cher que l'écart"],
            &["Efficacité", "Non : la comparabilité clinique fait partie de l'autorisation, et le recul est maintenant de plus de quinze ans en Europe", "Répondre avec ce recul chiffré : c'est la question la plus fréquente des patients", "Répondre « c'est pareil » sans argumenter : la réponse paraît évasive"],
            &["Tolérance", "Non, y compris l'immunogénicité, qui est le point spécifiquement évalué pour ces produits", "Déclarer tout effet indésirable avec la marque et le lot ; c'est ce suivi qui alimente la connaissance", "Attribuer au biosimilaire un effet apparu au même moment qu'un autre changement de traitement"],
            &["Conservation", "Chaîne du froid entre 2 et 8 °C, jamais de congélation, et une durée hors réfrigérateur propre à chaque spécialité", "Donner un sac isotherme, dire la durée exacte pour cette marque-là, et rappeler qu'un produit congelé se jette", "Transposer la durée hors froid d'une marque à l'autre : elles ne sont pas les mêmes"],
        ],
    },
    ConvTable {
        short: "Canicule",
        family: "Au comptoir",
        title: "Canicule — traitements à risque",
    ...
    ConvTable {
        ...
        columns: &["Forme ou médicament", "Motif", "Alternative"],
        rows: &[
            ...
            &["Médicaments photosensibles restant en plaquette opaque", "L'aluminium de la plaquette les protège ; une case transparente ne protège rien", "Garder la plaquette et repérer les jours dessus"],
            ...
            &["Changement en cours de semaine", "Un pilulier préparé le lundi porte l'ordonnance du lundi : une dose modifiée le mercredi reste fausse dans les cases suivantes", "Refaire le pilulier à chaque changement, et noter la date de préparation dessus"],
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["Formes contenant de l'alcool", "Sirops, solutions buvables, formes en ampoule et certains bains de bouche en contiennent", "Lire la composition et proposer une forme sans alcool", "Considérer que l'alcool d'un excipient est négligeable chez quelqu'un en sevrage"],
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["Durée", "Le sevrage se joue sur des mois, pas sur des semaines", "Au moins 3 mois à dose pleine, puis décroissance progressive sur 1 à 3 mois selon la tolérance", "Arrêter les substituts à un mois parce que « ça va » ramène le patient à la cigarette"],
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["Formes à ne jamais écraser", "Libération prolongée, formes gastro-résistantes, comprimés enrobés d'un principe irritant, cytotoxiques", "Demander une autre forme au prescripteur : solution buvable, forme orodispersible dissoute, ou une autre molécule. La table « Broyage » dit laquelle"],
            ...
            &["Une forme par prise, jamais un mélange", "Deux médicaments broyés ensemble réagissent, précipitent et bouchent — et l'un peut annuler l'autre", "Un médicament, de l'eau, un rinçage, le suivant. Cela prend plus de temps, et cela évite le changement de sonde"],
            ...
            &["Consignes à écrire", "L'entourage refait à la maison ce qu'on a montré une fois", "Écrire la séquence sur le plan de prise : rincer, donner, rincer — et le nom des médicaments à donner à distance de la nutrition"],
        ],
    },
    ConvTable {
        short: "Voyage",
        family: "Au comptoir",
        title: "Voyage — ordonnance, trousse et décalage horaire",
        ...
        columns: &["Point", "À savoir", "À préparer"],
        rows: &[
            &["L'ordonnance", "Un nom de marque français n'a pas cours ailleurs, et certains pays contrôlent les stupéfiants et les psychotropes à l'entrée", "Une ordonnance en DCI, et pour les stupéfiants une attestation de transport délivrée par l'ARS. Se renseigner sur le pays : ce qui est banal ici est interdit là-bas"],
            ...
            &["La trousse de base", "Ce qui manque le plus ne s'achète pas facilement sur place", "Antalgique, antidiarrhéique et soluté de réhydratation, antiseptique et pansements, répulsif anti-moustiques, crème solaire, thermomètre, et le traitement habituel"],
    ...
    ConvTable {
        ...
        rows: &[
            ...
            &["Interprétation du total", "—", "—", "CHA₂DS₂-VASc ≥ 2 chez l'homme ou ≥ 3 chez la femme : anticoaguler. HAS-BLED ≥ 3 : pas une contre-indication, mais des facteurs de risque hémorragique à corriger"],
        ],
    },
    ConvTable {
        short: "HbA1c",
    ...
    ConvTable {
        short: "AVK",
        family: "Adaptation",
        title: "AVK — INR cible, surdosage et relais",
        reviewed: "Septembre 2026 — grille de surdosage HAS et RCP des spécialités",
        sources: &[
            "HAS — prise en charge des surdosages en AVK, des situations à risque hémorragique et des accidents hémorragiques",
            "ANSM — carnet d'information et de suivi du traitement par AVK ; restriction de primo-prescription de la fluindione (2018)",
            "RCP des spécialités (ANSM) : Coumadine, Previscan, Sintrom, Konakion, Eliquis, Xarelto, Pradaxa",
            "ESC — cibles d'INR des prothèses valvulaires mécaniques",
        ],
        columns: &["Situation", "INR", "Conduite à tenir", "Vitamine K", "Contrôle", "Écueil"],
        rows: &[
            &["Warfarine (Coumadine)", "Cible selon l'indication", "AVK de première intention en instauration ; demi-vie 35 à 45 h, équilibre atteint en 4 à 6 jours", "Konakion 10 mg/1 mL adulte et 2 mg/0,2 mL pédiatrique, buvable ou injectable", "INR 48 à 72 h après toute modification de dose, puis mensuel une fois stable", "Juger d'un changement de dose à 24 h : l'INR n'a pas fini de bouger"],
            &["Fluindione (Previscan)", "Cible selon l'indication", "Poursuite possible chez un patient équilibré ; primo-prescription contre-indiquée depuis 2018 pour risque immuno-allergique", "Même antagonisation que la warfarine", "INR mensuel une fois stable", "Instaurer une fluindione chez un patient neuf — c'est la warfarine qui se prescrit"],
            &["Acénocoumarol (Sintrom, Minisintrom)", "Cible selon l'indication", "Demi-vie courte, 8 à 11 h : INR plus labile, souvent deux prises par jour", "Même antagonisation que la warfarine", "INR plus rapproché qu'avec la warfarine", "Une prise sautée pèse ici bien plus qu'avec un AVK à demi-vie longue"],
            &["Fibrillation atriale, MTEV, prothèse biologique", "2,0 à 3,0, cible 2,5", "Cible de la très grande majorité des indications", "Aucune tant que l'INR est dans la cible", "Mensuel une fois stable, 48 à 72 h après tout changement de dose", "Espacer les contrôles au-delà d'un mois parce que « c'est stable depuis un an »"],
            &["Prothèse valvulaire mécanique", "2,5 à 4,5 selon la prothèse et le patient", "Cible fixée par le cardiologue et inscrite sur le carnet de suivi", "Aucune sans avis spécialisé : la correction expose à la thrombose de prothèse", "Mensuel, sans jamais interrompre le traitement", "Appliquer la cible 2 à 3 et la grille de surdosage ci-dessous : elles ne valent pas pour ces patients"],
            &["Surdosage asymptomatique, cible 2 à 3", "INR < 4", "Pas de saut de prise, pas de modification de dose", "Aucune", "INR le lendemain", "Baisser la dose de sa propre initiative"],
            &["Surdosage asymptomatique, cible 2 à 3", "4 ≤ INR < 6", "Saut d'une prise, rien d'autre", "Aucune", "INR le lendemain", "Sauter deux prises « pour être tranquille » : l'INR repasse sous la cible"],
            &["Surdosage asymptomatique, cible 2 à 3", "6 ≤ INR < 10", "Arrêt du traitement, avis du prescripteur le jour même", "1 à 2 mg per os, soit une demie à une ampoule buvable pédiatrique de 2 mg", "INR le lendemain, reprise à dose réduite sur avis", "Utiliser l'ampoule adulte de 10 mg : cinq fois trop, et la reprise du traitement devient difficile"],
            &["Surdosage asymptomatique, cible 2 à 3", "INR ≥ 10", "Arrêt du traitement, avis spécialisé sans délai", "5 mg per os, soit une demi-ampoule buvable adulte de 10 mg", "INR à 24 h, hospitalisation selon le terrain", "Gérer à domicile un INR ≥ 10 chez un patient âgé, isolé ou à risque de chute"],
            &["Hémorragie grave ou non contrôlable", "Quel que soit l'INR", "Urgence vitale : appel du 15, hospitalisation, concentré de complexe prothrombinique à l'hôpital", "10 mg par voie intraveineuse lente, à l'hôpital", "INR 30 min après le concentré, puis à 6 à 8 h", "Attendre le résultat d'un INR pour agir : une hémorragie grave se traite sans lui"],
            &["Saignement mineur, gingivorragie, épistaxis", "À contrôler le jour même", "Compression locale, mèche hémostatique ; rechercher un surdosage et une cause locale", "Selon l'INR mesuré et l'avis du prescripteur", "INR le jour même", "Le banaliser : un saignement mineur répété est le premier signe d'un surdosage"],
            &["Oubli d'une prise", "Sans conséquence si l'oubli reste isolé", "Prise possible si l'oubli est constaté dans les 8 h qui suivent l'heure habituelle ; au-delà, prise sautée", "Aucune", "Oubli noté sur le carnet et signalé au prochain INR", "Doubler la dose le lendemain"],
            &["Relais héparine vers AVK", "Deux INR dans la cible à 24 h d'intervalle", "Chevauchement d'au moins 5 jours avant l'arrêt de l'héparine", "Aucune", "INR à partir du 3e jour, puis quotidien jusqu'à l'arrêt de l'héparine", "Arrêter l'héparine au premier INR dans la cible : les facteurs vitamine K-dépendants ne sont pas tous effondrés"],
            &["Relais AVK vers AOD", "INR mesuré avant la première prise d'AOD", "Arrêt de l'AVK puis début de l'AOD selon son RCP : INR < 2 pour l'apixaban et le dabigatran, ≤ 3,0 pour le rivaroxaban en fibrillation atriale", "Aucune", "Plus aucun INR ensuite : il ne mesure rien sous AOD", "Faire chevaucher les deux traitements, ou continuer à surveiller l'INR après le relais"],
            &["Introduction d'un médicament interférent", "Contrôle 3 à 5 jours après", "Miconazole buccal ou gel : association contre-indiquée. AINS et aspirine à dose antalgique : refusés en automédication. Cotrimoxazole, azolés, amiodarone, macrolides : INR à contrôler", "Selon l'INR obtenu", "INR 3 à 5 jours après l'introduction, et de nouveau après l'arrêt de la cure", "Ne contrôler qu'à l'introduction : l'INR rebascule aussi quand l'antibiotique s'arrête"],
            &["Apports alimentaires en vitamine K", "Variations d'INR sans changement de dose", "Régularité des apports d'une semaine à l'autre, jamais suppression des légumes verts", "Apport alimentaire, sans valeur thérapeutique", "INR après tout changement durable d'habitudes", "Interdire les légumes verts : un régime pauvre en vitamine K rend l'INR instable, pas stable"],
            &["Soin dentaire ou geste à faible risque hémorragique", "INR dans la cible, contrôle de moins de 24 h", "Extraction simple, détartrage, chirurgie cutanée : l'AVK n'est pas interrompu", "Aucune", "INR de moins de 24 h avant le geste", "Arrêter l'AVK pour une extraction : le risque thrombotique dépasse ici le risque hémorragique"],
        ],
    },
    ConvTable {
        short: "Vitamine D",
        family: "Équivalences",
        title: "Vitamine D — UI, microgrammes, gouttes et ampoules",
        reviewed: "Septembre 2026 — RCP des spécialités et recommandations du GRIO",
        sources: &[
            "RCP des spécialités, base de données publique des médicaments (ANSM)",
            "GRIO — supplémentation en vitamine D chez l'adulte",
            "Société française de pédiatrie — supplémentation en vitamine D en population pédiatrique générale",
            "ANSM et ANSES — hypercalcémies du nourrisson liées aux compléments alimentaires contenant de la vitamine D",
            "HAS — utilité clinique du dosage de la 25-OH-vitamine D",
        ],
        columns: &["Présentation", "Teneur", "Équivalent", "Emploi", "Écueil"],
        rows: &[
            &["Cholécalciférol — règle de conversion", "1 µg = 40 UI", "100 000 UI = 2,5 mg", "Toutes les formes de vitamine D3", "Les compléments alimentaires sont libellés en µg, les médicaments en UI : 25 µg sur une boîte de parapharmacie, ce sont 1 000 UI"],
            &["Uvedose 100 000 UI (cholécalciférol)", "100 000 UI par ampoule de 2 mL", "2,5 mg de cholécalciférol", "Adulte : correction d'une carence, puis entretien tous les 2 à 3 mois", "Rapprocher les ampoules de sa propre initiative fait l'hypercalcémie : noter la date sur le carnet"],
            &["ZymaD ampoules buvables", "50 000, 80 000 ou 200 000 UI selon l'ampoule", "1,25 mg, 2 mg ou 5 mg de cholécalciférol", "Adulte et grand enfant, selon la prescription", "Trois dosages sous le même nom : lire le chiffre de l'ampoule, pas le nom de la boîte"],
            &["ZymaD solution buvable en gouttes", "10 000 UI/mL, soit 300 UI par goutte", "2 gouttes = 600 UI", "Nourrisson et enfant, apport quotidien", "Compter les gouttes dans une cuillère, jamais au flacon tenu au-dessus de la bouche"],
            &["ZymaDuo 150 UI et 300 UI (vitamine D + fluor)", "150 ou 300 UI et 0,0625 mg de fluor par goutte", "4 gouttes de ZymaDuo 150 = 600 UI et 0,25 mg de fluor", "Nourrisson, quand le fluor est indiqué", "Deux dosages de vitamine D pour le même fluor, sous un nom voisin de ZymaD : jamais avec un autre apport fluoré"],
            &["Dédrogyl (calcifédiol, 25-OH-D3)", "5 µg par goutte ; 1 mL = 30 gouttes", "Pas d'équivalence en UI de cholécalciférol", "Insuffisance rénale chronique, malabsorption digestive", "Molécule déjà hydroxylée : elle agit sans passer par le foie et devient hypercalcémiante bien plus vite ; une goutte de trop répétée suffit"],
            &["Un-Alfa (alfacalcidol)", "0,1 µg par goutte ; 1 mL = 20 gouttes ; capsules 0,25, 0,5 et 1 µg", "Pas d'équivalence en UI", "Insuffisance rénale, hypoparathyroïdie", "Dérivé actif : il ne remplace pas le cholécalciférol et ne corrige pas le dosage de 25-OH ; calcémie après chaque changement de dose"],
            &["Rocaltrol (calcitriol)", "Capsules 0,25 et 0,5 µg", "Pas d'équivalence en UI", "Insuffisance rénale chronique, hypocalcémie", "Forme active terminale, la plus hypercalcémiante : calcémie et phosphorémie à chaque changement de dose, et prise à distance du sévélamer — 1 h avant ou 3 h après"],
            &["Associations calcium-vitamine D", "400 à 800 UI par prise selon la spécialité", "Deux prises par jour = 800 à 1 600 UI", "Ostéoporose, sujet âgé, relais d'un traitement anti-ostéoporotique", "Doublon fréquent avec une ampoule trimestrielle : additionner l'ordonnance entière avant d'ajouter une dose de charge"],
            &["Nourrisson et enfant", "400 à 800 UI par jour", "1 à 2 gouttes de ZymaD 10 000 UI/mL, soit 300 à 600 UI", "Prévention de la carence, apport quotidien plutôt que doses de charge espacées", "Les compléments alimentaires vendus hors pharmacie ont provoqué des hypercalcémies du nourrisson : un médicament, un compte-gouttes, une dose"],
            &["Dosage de la 25-OH-vitamine D", "Rendu en ng/mL en France", "1 ng/mL = 2,5 nmol/L ; cible ≥ 30 ng/mL = 75 nmol/L", "Contrôle d'une carence documentée ou d'une situation à risque", "Ce n'est pas un examen de dépistage : sa prise en charge est limitée à des indications précises"],
            &["Surdosage", "Hypercalcémie", "Soif, polyurie, nausées, constipation, confusion", "À rechercher devant toute prise rapprochée ou tout doublon", "Doser la calcémie avant d'attribuer ces signes à l'âge ; arrêter la vitamine D et le calcium associé, et prévenir le prescripteur"],
        ],
    },
    ConvTable {
        short: "Unités",
        family: "Équivalences",
        title: "Unités — conversion des résultats de biologie",
        reviewed: "Septembre 2026 — masses molaires et seuils des recommandations en vigueur",
        sources: &[
            "Masses molaires : créatinine 113,1 ; glucose 180,2 ; urée 60,1 ; cholestérol 386,7 ; acide urique 168,1 ; bilirubine 584,7 ; cyanocobalamine 1 355 ; digoxine 780,9 ; 25-OH-vitamine D 400,6",
            "IFCC / NGSP — équation de conversion de l'hémoglobine glyquée",
            "HAS et sociétés savantes — seuils cités (diabète, LDL, albuminurie, carence martiale)",
        ],
        columns: &["Analyte", "Conversion", "Réciproque", "Valeurs usuelles", "Seuil", "Écueil"],
        rows: &[
            &["Créatininémie", "1 mg/L = 8,84 µmol/L", "1 µmol/L = 0,113 mg/L ; 1 mg/dL = 88,4 µmol/L", "60 à 110 µmol/L chez l'homme, 45 à 90 chez la femme", "Le seuil est le DFG, pas la créatinine : adaptation en dessous de 60 mL/min", "Lire une créatinine « normale » chez un sujet âgé peu musclé : 90 µmol/L peut recouvrir un DFG à 40"],
            &["Glycémie à jeun", "1 g/L = 5,55 mmol/L", "1 mmol/L = 0,18 g/L ; mg/dL ÷ 100 = g/L", "0,70 à 1,10 g/L, soit 3,9 à 6,1 mmol/L", "Diabète : ≥ 1,26 g/L (7,0 mmol/L, 126 mg/dL) sur deux dosages veineux", "Poser un diagnostic sur une glycémie capillaire : le seuil est veineux et au laboratoire"],
            &["Hémoglobine glyquée", "% (NGSP) vers mmol/mol (IFCC) : (% − 2,15) × 10,93", "mmol/mol vers % : ÷ 10,93 + 2,15", "Sujet non diabétique : < 6,0 %, soit < 42 mmol/mol", "6,5 % = 48 ; 7 % = 53 ; 8 % = 64 mmol/mol", "Lire un résultat en mmol/mol comme un pourcentage : 53 mmol/mol ne sont pas 53 %"],
            &["Cholestérol total, LDL, HDL", "1 g/L = 2,59 mmol/L", "1 mmol/L = 0,387 g/L ; mg/dL ÷ 100 = g/L", "LDL 1,00 g/L = 2,6 mmol/L ; HDL 0,40 g/L = 1,0 mmol/L", "Cibles de LDL : 0,55 — 0,70 — 1,00 — 1,16 g/L selon le niveau de risque", "Appliquer le facteur du cholestérol aux triglycérides : ce n'est pas la même masse molaire"],
            &["Triglycérides", "1 g/L = 1,14 mmol/L", "1 mmol/L = 0,875 g/L", "< 1,50 g/L, soit < 1,7 mmol/L", "Risque de pancréatite au-delà de 10 g/L (11,3 mmol/L)", "Interpréter un dosage fait sans jeûne : 12 h de jeûne sont nécessaires"],
            &["Urée", "1 g/L = 16,65 mmol/L", "1 mmol/L = 0,06 g/L", "2,5 à 7,5 mmol/L, soit 0,15 à 0,45 g/L", "Urée haute avec créatinine peu modifiée : déshydratation", "Confondre l'urée et l'azote uréique (BUN) des comptes rendus anglo-saxons : BUN en mg/dL × 0,357 = mmol/L d'urée — un BUN de 20 fait 7,1, pas 20"],
            &["Calcémie", "1 mmol/L = 40,1 mg/L", "1 mg/L = 0,025 mmol/L", "2,20 à 2,60 mmol/L, soit 88 à 104 mg/L", "Correction sur l'albumine : Ca corrigé = Ca mesuré + 0,02 × (40 − albumine en g/L)", "Lire une calcémie basse sans regarder l'albumine : une hypoalbuminémie l'abaisse sans hypocalcémie vraie"],
            &["Magnésémie", "1 mmol/L = 24,3 mg/L", "1 mg/L = 0,041 mmol/L", "0,75 à 1,00 mmol/L, soit 18 à 24 mg/L", "Hypomagnésémie sous IPP au long cours : < 0,70 mmol/L", "Écarter un déficit sur une magnésémie normale : le sérum ne porte que 1 % du stock"],
            &["Phosphorémie", "1 mmol/L = 31 mg/L", "1 mg/L = 0,032 mmol/L", "0,80 à 1,45 mmol/L, soit 25 à 45 mg/L", "Hyperphosphorémie des stades 4 et 5 : chélateurs selon le produit", "Oublier l'hypophosphorémie qui suit une perfusion de carboxymaltose ferrique"],
            &["Uricémie", "1 mg/L = 5,95 µmol/L", "1 µmol/L = 0,168 mg/L", "180 à 420 µmol/L, soit 30 à 70 mg/L", "Cible sous hypo-uricémiant : < 360 µmol/L (60 mg/L), < 300 (50 mg/L) si tophus", "Doser pendant la crise : l'uricémie y est souvent normale, le dosage se fait à distance"],
            &["Bilirubine totale", "1 mg/L = 1,71 µmol/L", "1 µmol/L = 0,585 mg/L ; 1 mg/dL = 17,1 µmol/L", "< 17 µmol/L, soit < 10 mg/L", "Ictère visible au-delà de 50 µmol/L environ", "Prendre une hyperbilirubinémie libre isolée pour une hépatite : c'est le plus souvent un syndrome de Gilbert"],
            &["Hémoglobine", "1 g/dL = 10 g/L", "1 g/L = 0,1 g/dL", "13 à 17 g/dL chez l'homme, 12 à 16 chez la femme", "Anémie : < 13 g/dL chez l'homme, < 12 chez la femme, < 11 pendant la grossesse", "Lire 13 g/dL comme 13 g/L : l'unité change d'un laboratoire à l'autre"],
            &["Numération — leucocytes, PNN, plaquettes", "1 G/L = 1 000 éléments/mm³", "1 000/mm³ = 1 G/L", "Plaquettes 150 à 400 G/L ; PNN 1,5 à 7 G/L", "Neutropénie sévère sous 0,5 G/L (500/mm³)", "Lire un compte rendu en /mm³ contre un seuil écrit en G/L : mille fois d'écart"],
            &["Vitamine D (25-OH)", "1 ng/mL = 2,5 nmol/L", "1 nmol/L = 0,4 ng/mL", "Suffisance : 30 à 60 ng/mL, soit 75 à 150 nmol/L", "Carence : < 10 ng/mL (25 nmol/L)", "Confondre le dosage (ng/mL) et la dose prescrite (UI) : 1 µg = 40 UI, une ampoule de 100 000 UI fait 2,5 mg"],
            &["Vitamine B12", "1 pg/mL = 0,738 pmol/L", "1 pmol/L = 1,36 pg/mL", "200 à 800 pg/mL, soit 150 à 600 pmol/L", "Carence probable en dessous de 200 pg/mL (150 pmol/L)", "Chercher un facteur entre ng/L et pg/mL : c'est la même unité"],
            &["Digoxinémie", "1 ng/mL = 1,28 nmol/L", "1 nmol/L = 0,78 ng/mL", "Zone utile 0,5 à 0,9 ng/mL, soit 0,6 à 1,2 nmol/L", "Zone toxique au-delà de 2,0 ng/mL (2,6 nmol/L), et plus bas si hypokaliémie", "Prélever moins de 6 h après la prise : le taux mesuré est celui de la distribution, pas de l'équilibre"],
            &["Ionogramme, sodium et potassium", "1 mEq/L = 1 mmol/L pour un ion monovalent", "Ion divalent : 1 mmol = 2 mEq (calcium, magnésium)", "Sodium 135 à 145 mmol/L, potassium 3,5 à 5,0 mmol/L", "Hyperkaliémie : > 5,0 mmol/L ; urgence au-delà de 6,0", "Étendre l'égalité mEq = mmol au calcium : 2,5 mmol/L font 5 mEq/L"],
            &["Rapport albuminurie/créatininurie", "1 mg/mmol = 8,84 mg/g", "1 mg/g = 0,113 mg/mmol", "Normal : < 3 mg/mmol, soit < 30 mg/g", "Albuminurie modérée 3 à 30 mg/mmol (30 à 300 mg/g), sévère au-delà", "Comparer un rapport rendu en mg/g à un seuil écrit en mg/mmol"],
            &["Ferritine", "µg/L et ng/mL sont la même unité", "Aucun facteur à appliquer", "30 à 300 µg/L chez l'homme, 15 à 200 chez la femme", "Carence martiale : < 30 µg/L, < 100 en cas d'inflammation ou d'insuffisance cardiaque", "Lire une ferritine normale comme l'absence de carence en contexte inflammatoire : lire aussi le coefficient de saturation"],
            &["Débit de filtration glomérulaire", "Cockcroft rend des mL/min", "MDRD et CKD-EPI rendent des mL/min/1,73 m²", "Pas d'équivalence entre les deux : ce ne sont pas les mêmes unités", "Le RCP d'un AOD raisonne en clairance de Cockcroft", "Adapter une dose d'AOD sur un DFG indexé : chez l'obèse et le sujet très maigre les deux divergent"],
        ],
    },
];
...
mod tests {
    ...
    fn tables_are_well_formed() {
        ...
        assert!(
            TABLES.len() >= 46,
            "{} tables livrées, il y en avait quarante-six",
            TABLES.len()
        );
