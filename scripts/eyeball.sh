...
views=(
    ...
    vaccins bio watch rein grossesse age cyp ddi ddi_crush libelles listes revue locations conciliation vaccine_map ordonnance ordonnance_lignes vaccins_grossesse vaccins_catalogue ruptures reseau versions postes connexions
    protocols protocol_open codex codex_open dispositifs dispositif_open
    finances stats companion companion_poso companion_conseils companion_soins companion_dossier companion_vide companion_doublon companion_boite script carnets carnets_edit textes graph graph_zoom graph_wide graph_ordonnance stup stup_catalogue saisie ordonnancier vigilance destruction scans patient_scans patient_dose fil registres regles aide
