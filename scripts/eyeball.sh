...
views=(
    ...
    vaccins bio watch rein grossesse age cyp ddi ddi_crush libelles listes revue locations conciliation vaccine_map ordonnance ordonnance_lignes vaccins_grossesse vaccins_catalogue ruptures
