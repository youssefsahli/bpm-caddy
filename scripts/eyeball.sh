...
views=(
    ...
    finances stats companion companion_poso companion_conseils companion_soins companion_dossier companion_vide script carnets carnets_edit textes graph stup stup_catalogue saisie ordonnancier vigilance destruction scans patient_scans fil registres aide
