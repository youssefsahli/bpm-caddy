...
views=(
    ...
    protocols protocol_open codex codex_open dispositifs dispositif_open graph stup stup_catalogue ordonnancier vigilance destruction scans patient_scans fil registres explorer explorer_organ classes classes_outside export finances stats companion script carnets caisse
