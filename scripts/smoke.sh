...
views=(
    ...
    protocols protocol_open codex codex_open dispositifs dispositif_open graph stup stup_catalogue ordonnancier scans patient_scans registres explorer explorer_organ classes classes_outside export
