...
### Changed
- Options › Mentions : sur grand écran, les huit mentions en deux colonnes,
  toutes visibles sans défiler.
- Options › Officine : le tableau de l'équipe tient dans la fenêtre en
  grand texte, et la qualité « Préparateur en pharmacie » s'écrit en entier.
...
### Fixed
- Protocoles, codex des préparations, dispositifs médicaux : le champ du
  nom reste à côté du bouton qui crée ; « Imprimer » passe avant eux.

## [0.347.0] - 2026-09-26

### Fixed
- Historique de caisse : « ‹ mois › » reste d'un seul tenant ; la flèche
  qui recule d'un mois ne finit plus la rangée au-dessus du mois qu'elle
  change.

## [0.346.0] - 2026-09-26

### Changed
- Agenda, journée : heure, nature, patient, téléphone et « Déplacer » en
  colonnes quand la ligne tient — le bouton au même endroit sur chaque
  ligne.
- Carte vaccinale : les boutons de regroupement restent affichés quand ils
  tiennent ; le menu ne les remplace que sur un écran trop court.

### Fixed
- Agenda : le compte des rendez-vous (affichés, masqués, chevauchements)
  ne se coupe plus en deux au bout de la rangée des filtres.
- Postes de l'officine : l'explication entière s'affiche dès que l'écran
  a la place.
- Recettes : sur petit écran, le second bouton passe à la ligne sous le
  titre et non sous le premier bouton.
...
### Changed
- Après chaque synchronisation des postes, le registre des stupéfiants
  n'est plus occupé quand aucune ligne n'attend son numéro.
...
### Fixed
- Postes : une écriture refusée pendant la mise en place de la
  synchronisation ne bloque plus les enregistrements suivants.
- Postes : une même modification reçue deux fois en même temps n'est
  plus appliquée deux fois.

## [0.339.0] - 2026-09-25

### Changed
- Aide : une officine qui prend le nom d'une autre est suivie du début
  de son empreinte ; le nom saisi dans la fenêtre du réseau fait foi.

## [0.338.0] - 2026-09-25

### Fixed
- Carte des connexions : un poste non relié s'affiche « Non relié »
  quand la place manque, au-dessus de son carré quand dessous il
  couvrirait « Ce poste ».
...
### Fixed
- Vue Connexions : « database is locked » ne reste plus affiché sur un
  écran immobile ; la vue se relit d'elle-même.
- Sauvegarde du jour : retentée si la base est occupée au lancement, au
  lieu d'être sautée.

### Security
- Noms d'officines comparés sans tenir compte des espaces, tirets et
  caractères invisibles, aussi pour les officines à portée et présentées
  par le réseau.

## [0.335.0] - 2026-09-25

### Security
- Une officine qui prend le nom d'une autre, ou celui de cette
  officine, est affichée avec son empreinte : envois, messagerie, carte
  des connexions, fenêtre du réseau.
- Une annonce contrefaite sur le réseau local ne retarde plus la
  connexion à une officine appairée.
- Connexion à une officine appairée ou à un poste, et invitation à une
  voisine, bornées dans le temps.
- Limite des tentatives de connexion appliquée par réseau en IPv6.
...
### Added
- Insigne de chaque officine dans la fenêtre du réseau et la vue
  Connexions.

### Fixed
- Fenêtre du réseau : la mention « aucune écoute permanente », devenue
  fausse, dit maintenant que seules les officines appairées reçoivent une
  réponse.
- Moins d'envois en double quand deux synchronisations se croisent.

## [0.332.0] - 2026-09-25

### Added
- Messages : l'insigne de chaque officine (initiales, couleur) à côté de
  son nom, comme sur la carte des connexions.

## [0.331.0] - 2026-09-25

### Added
- Carte des connexions : « Créer un réseau et l'inviter » sur une
  officine voisine, quand l'officine n'a pas encore de réseau.

## [0.330.0] - 2026-09-25

### Fixed
- « Inviter un poste… » ne répond plus « port pris » quand la
  synchronisation automatique tournait.

## [0.329.0] - 2026-09-25

### Added
- Carte des connexions : « Inviter ce poste » sur un poste non relié,
  quand ce poste-ci est d'un groupe ; le code s'affiche aussitôt.
...
### Fixed
- **Trame** : la légende des deux semaines se centre sur la rangée des
  commandes au lieu de flotter au-dessus.

## [0.308.0] - 2026-09-24

### Fixed
- **Planning** : le clic sur un nom ouvre sa trame même quand la grille
  est défilée de côté — il tombait sur la première case de jour, que le
  nom épinglé recouvre.
...
### Fixed
- **Premiers pas** : « Réseau d'officines » disait « partager les
  ruptures » ; il dit ce qui se partage — ruptures, fiches, protocoles et
  vaccins.
- **Connexions** : la dernière synchronisation du réseau se lit « 15:57 —
  Synchronisé : … » au lieu de « Dernière synchronisation à 15:57 :
  Synchronisé : … », dans la taille des lignes voisines ; la phrase
  d'en-tête dit tout ce que le réseau partage.

## [0.305.0] - 2026-09-24

### Added
- **Planning** : un clic sur le nom d'une personne dans la grille de la
  semaine ouvre sa trame, sans passer par le menu « Qui » et « Trame… ».

### Changed
- **Connexions, « Derniers reçus »** : une version reçue dit de quelle
  sorte elle est — « Vaccin Grippe », « Ligne de TROD … », « Préparation
  … », « Protocole … » — au lieu d'un nom qui se lisait comme une fiche
  médicament.

## [0.304.0] - 2026-09-24

### Fixed
- **Bilan partagé de médication** et **fiche d'un dispositif médical**
  imprimés : chaque intertitre flottait loin de son filet et collait au
  tableau qui le précédait ; il se pose maintenant sur son filet, avec
  l'espace au-dessus, et ne reste plus seul en bas de page.
...
### Added
- **Le catalogue des vaccins est celui de l'officine.** Ce que le carnet
  propose quand on tape un nom vit dans la base, semé une fois depuis le
  catalogue livré, et se réécrit avec « Vaccins proposés… » (volet « À
  faire » du carnet) : libellé, code du calendrier, schéma. Un vaccin
  ajouté sans code se note comme les autres ; un vaccin retiré ne
  revient pas, et les doses déjà inscrites gardent leur nom.
...
### Fixed
- **Une passe de maintenance qui s'interrompt sans rendre compte le dit**,
  à l'endroit du bouton qui l'a lancée, et l'écran relit la base : une
  réinitialisation tombée après avoir vidé les tables laissait à l'écran
  des listes que la base ne portait plus, sans un mot.
...
### Fixed
- **Le comptoir n'attend plus une mise à jour lente.** Pendant un
  téléchargement, le lanceur offre « Lancer la version installée »
  quand une version entière est là : sur une ligne lente, trente
  mégaoctets prenaient des minutes, et fermer la fenêtre laissait sans
  application. La mise à jour est reprise au démarrage suivant, et les
  fichiers temporaires qu'un lanceur quitté en route laisse sont
  nettoyés.
- En biologie, deux règles disaient « transaminases au-delà de trois
  fois la normale » à 120 et à 150 : l'écran l'écrivait deux fois sous
  statine. Fondues en une, au seuil de trois fois la normale.
