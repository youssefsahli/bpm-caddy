...
- **« Plan de prise »** — the patient's own copy of the entretien: one line per treatment (le médicament, à quoi ça sert, quand le prendre, ce qu'il faut savoir — starting with what to do when a dose is missed), a box for their questions, and the pharmacy's number. The bilan stays at the officine; this one goes home.
