...
- **Team messaging** — conversations between colleagues across the officine's posts (a few colleagues, a named group, or the whole team), encrypted under the posts' key; a message can link the open patient file; unread count in the status bar; favorite contacts.
